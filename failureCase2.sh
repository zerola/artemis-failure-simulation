...
java -cp "target/classes/:target/dependency/*" -Dindex=0 ${OPTIONS} com.deutscheboerse.artemisfailure.Consumer &
java -cp "target/classes/:target/dependency/*" -Dindex=1 ${OPTIONS} com.deutscheboerse.artemisfailure.Consumer &
java -cp "target/classes/:target/dependency/*" -Dindex=2 ${OPTIONS} com.deutscheboerse.artemisfailure.Consumer &
